            ...
            <div
                ...
                <div class="rounded-t bg-white mb-0 px-6 py-6 dark:bg-darker dark:text-light">
                    <div class="text-center flex justify-between">
                        ...
                        <a
                            href="{{ route('admin.catalog.attributeValues.create') }}"
                ...
                <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                    <div class="w-full overflow-x-hidden">
                        <hr>
                        <table class="w-full stripe cell-border compact hover order-column row-border" id="attributeValuesTable">
                            <thead>
                                <tr
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#attributeValuesTable').DataTable({
                ...
                "processing": true,
                "ajax": {
                    "url": "{{route('admin.catalog.getProductAttributeValues')}}",
                    "dataType": "json",
                    "type": "POST",
