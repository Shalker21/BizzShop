    ...
    <section class="bg-blueGray-50">
        <div class="w-full lg:w-8/12 px-4 mx-auto mt-6">
            <div
                ...
                @endif
                <form action="{{ route('admin.catalog.categories.update', ['id' => $category->id]) }}" method="POST"
                            ...
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input type="text" id="name" name="name"
                                        ...
                                        value="{{ $category->category_translation->name }}">
                                </div>
                            </div>
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                        ...
                                        <select id="parent_id" name="parent_id"
                                            ...
                                            @foreach ($categories as $c)
                                                @if ($c->parent->id == $category->parent_id)
                                                    <option value="{{ $c->id }}" selected>{{ $c->category_translation->name }}</option>
                                                @else
                                                <option value="{{ $c->id }}">{{ $c->category_translation->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="w-full lg:w-4/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input name="featured" type="checkbox" class="form-checkbox h-5 w-5 text-gray-600"
                                        @if (isset($category->featured) && $category->featured)
                                    checked
                                    @endif
                                    />
                                </div>
                            ...
                            <div class="w-full lg:w-4/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input name="menu" type="checkbox" class="form-checkbox h-5 w-5 text-gray-600"
                                        @if (isset($category->menu) && $category->menu)
                                    checked
                                    @endif
                                    />
                                </div>
