...
<section class="bg-blueGray-50">
    <div class="w-full lg:w-8/12 px-4 mx-auto mt-6">
        <div
            ...
            @endif
            <form action="{{ route('admin.catalog.products.update') }}" method="POST" role="form" enctype="multipart/form-data">
                @csrf
                @method('POST')
                    ...
                    <div class="flex flex-wrap mt-9 border-b-2 border-blue-200">
                        ...
                        <div class="w-full lg:w-2/12 px-4">
                            <div class="relative w-full mb-3">
                                ...
                                <input id="enabled" name="enabled" type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" @if ($product->enabled) checked @endif>
                            </div>
                        </div>
