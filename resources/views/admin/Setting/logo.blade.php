            ...
            <div
                ...
                <form action="{{ route('admin.setting.update') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="bg-gray-800 text-white py-3 px-4 text-center fixed left-0 bottom-0 right-0 z-40">
                        This a Tailwind File Upload by shuvro_008. 
                        <a class="underline text-gray-200" href="https://tailwindcomponents.com/component/tailwind-file-upload">Component details</a>
                    </div>
